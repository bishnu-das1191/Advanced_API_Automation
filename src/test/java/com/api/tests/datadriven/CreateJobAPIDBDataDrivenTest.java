...
public class CreateJobAPIDBDataDrivenTest {
    ...
    // here we are going to use the data from database for data driven testing

    @Test(description = "Verify Create Job API Inwarranty Flow is working with DB data and response schema is valid",
            groups = {"api","regression","datadriven", "database"},
            dataProviderClass = com.dataproviders.DataProviderUtils.class,
            dataProvider = "CreateJobAPIDBDataProvider")
    public void createJobAPIDBDataTest(CreateJobPayload createJobPayload) {

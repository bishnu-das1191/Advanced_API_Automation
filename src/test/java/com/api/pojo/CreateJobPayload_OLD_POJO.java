...
public class CreateJobPayload_OLD_POJO {
    ...
    public CreateJobPayload_OLD_POJO(int mst_service_location_id, int mst_platform_id, int mst_warrenty_status_id, int mst_oem_id, Customer customer, CustomerAddress customer_address, CustomerProduct customer_product, Problems[] problems) {

...
public class CustomerProduct_OLD_POJO {
    ...
    public CustomerProduct_OLD_POJO(String dop, String serial_number, String imei1, String imei2, String popurl, int product_id, int mst_model_id) {
        this.dop = dop;

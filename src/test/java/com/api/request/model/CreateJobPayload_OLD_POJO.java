...
public class CreateJobPayload_OLD_POJO {
    ...
    private CustomerAddress_OLD_POJO customer_address;
    private CustomerProduct customer_product;
    private Problems[] problems;

    public CreateJobPayload_OLD_POJO(int mst_service_location_id, int mst_platform_id, int mst_warrenty_status_id, int mst_oem_id, Customer customer, CustomerAddress_OLD_POJO customer_address, CustomerProduct customer_product, Problems[] problems) {
    ...
    public CustomerAddress_OLD_POJO getCustomer_address() {
        return customer_address;
    }

    public void setCustomer_address(CustomerAddress_OLD_POJO customer_address) {
        this.customer_address = customer_address;
    }
